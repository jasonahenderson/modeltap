...
related:
  ...
  - "docs/releases/v0.3.0/retrospective.md (Finding F2)"
...
Finding F2 in `docs/releases/v0.3.0/retrospective.md`. Until F2 lands,
...
9. **Update `docs/patches/README.md` index** with the new row.
...
- [ ] Changelog entry: `docs/releases/v0.3.0/changelog.md` if this
  becomes a v0.3.0 pre-tag fix; `v0.3.1/changelog.md` otherwise
- [ ] Release-scope decision recorded in
  `docs/releases/v0.3.0/retrospective.md` outstanding-work section
