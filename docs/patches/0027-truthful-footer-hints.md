...
related:
  ...
  - "docs/releases/v0.3.0/retrospective.md (Finding F9)"
...
Recorded as Finding F9 in `docs/releases/v0.3.0/retrospective.md`.
...
- [ ] `docs/releases/v0.3.0/retrospective.md` Finding F9 status
