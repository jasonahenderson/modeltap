...
related:
  ...
  - "docs/releases/v0.3.0/retrospective.md (Finding F16)"
...
Recorded as Finding F16 in `docs/releases/v0.3.0/retrospective.md`.
...
- [ ] `docs/releases/v0.3.0/retrospective.md` F16 entry references
  this patch as fix
