...
related:
  ...
  - "docs/releases/v0.3.0/retrospective.md (Finding F20)"
...
Recorded as Finding F20 in `docs/releases/v0.3.0/retrospective.md`.
...
- [ ] `docs/releases/v0.3.0/retrospective.md` F20 entry references
  this patch as fix
