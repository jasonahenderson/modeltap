...
related:
  ...
  - "docs/releases/v0.3.0/retrospective.md (Finding F22)"
...
Recorded as Finding F22 in `docs/releases/v0.3.0/retrospective.md`.
...
- [ ] `docs/releases/v0.3.0/retrospective.md` F22 entry references
  this patch as fix
