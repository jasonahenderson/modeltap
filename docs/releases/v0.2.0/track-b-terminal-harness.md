...
**Size:** Medium | **Dependencies:** WU-039 | **Review tier:** B (UI component layout)
...
**Size:** Small | **Dependencies:** WU-068 | **Parallelizes with:** WU-070, WU-071 | **Review tier:** A (single component; rendering-only)
...
**Size:** Medium | **Dependencies:** WU-068 | **Parallelizes with:** WU-069, WU-071 | **Review tier:** B (defines key bindings)
...
**Size:** Medium | **Dependencies:** WU-068 | **Parallelizes with:** WU-069, WU-070 | **Review tier:** B (UI layout decisions + key bindings)
...
**Size:** Medium | **Dependencies:** WU-071 | **Parallelizes with:** WU-073 | **Review tier:** A (rendering logic; no shared contract)
...
**Size:** Medium | **Dependencies:** WU-039, WU-040, WU-041 | **Parallelizes with:** WU-069-072 | **Review tier:** C (TLS config + protocol client; cross-track contract)
...
**Size:** Large | **Dependencies:** WU-073 | **Parallelizes with:** WU-072 | **Review tier:** C (TLS + lifecycle state machine shared with BFF)
...
**Size:** Medium | **Dependencies:** WU-068 | **Parallelizes with:** WU-073, WU-074 | **Review tier:** C (permission policy + tool execution — listed C target)
...
**Size:** Large | **Dependencies:** WU-075 | **Parallelizes with:** WU-077, WU-078, WU-079 | **Review tier:** C (model-supplied file-path input + tool execution)
...
**Size:** Medium | **Dependencies:** WU-075 | **Parallelizes with:** WU-076, WU-078, WU-079 | **Review tier:** C (model-supplied file-path input + destructive tool execution)
...
**Size:** Medium | **Dependencies:** WU-075 | **Parallelizes with:** WU-076, WU-077, WU-079 | **Review tier:** C (shell invocation — listed C target)
...
**Size:** Medium | **Dependencies:** WU-075 | **Parallelizes with:** WU-076, WU-077, WU-078 | **Review tier:** C (file-path input + SSRF surface)
...
**Size:** Large | **Dependencies:** WU-075, WU-070, WU-071 | **Parallelizes with:** WU-079, WU-081 | **Review tier:** C (permission policy — plan-mode intercepts tool writes)
...
**Size:** Medium | **Dependencies:** WU-075, WU-073 | **Parallelizes with:** WU-080 | **Review tier:** C (stdio transport to external processes + tool execution)
...
**Size:** Medium | **Dependencies:** WU-076, WU-070 | **Parallelizes with:** WU-080, WU-081 | **Review tier:** C (file-path input via @file / drag-drop)
...
**Size:** Small | **Dependencies:** WU-070, WU-073 | **Parallelizes with:** WU-082 | **Review tier:** A (harness-local UI; uses already-defined content.transform protocol)
...
**Size:** Large | **Dependencies:** WU-073, WU-071, WU-068 | **Parallelizes with:** WU-080, WU-085 | **Review tier:** B (size L; UI layout + harness commands)
...
**Size:** Medium | **Dependencies:** WU-073, WU-071 | **Parallelizes with:** WU-084 | **Review tier:** B (UI layout for branch display)
...
**Size:** Medium | **Dependencies:** WU-074, WU-069 | **Parallelizes with:** WU-084, WU-085 | **Review tier:** B (UI layout + consumes diagnostic taxonomy)
...
**Size:** Large | **Dependencies:** all Track B | **Review tier:** B (validates the Track B surface; size L)
...
**Size:** Medium | **Dependencies:** WU-070, WU-073, WU-091 | **Parallelizes with:** WU-080-086 | **Review tier:** C (cross-track dependency on WU-091 contract)
