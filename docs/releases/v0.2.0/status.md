...
## Last Updated
2026-04-19 (WU-085 model commands landed)
...
- **Track B Bundle 13** (WU-080, WU-081, WU-082, WU-084): mode
  toggle / MCP / file context / session explorer. WU-086
  connection UX, WU-083 paste handler, WU-092 history traversal,
  and WU-085 model commands landed 2026-04-19 — 4 of Bundle 13's
  8 WUs complete. PATCH-0003 wired the App to an injectable
  ConnSurface, so /status, /reconnect, /history {scope}, /model,
  /models, paste summarize, and free-form turn.submit now all have
  a live path from App → BFF (when a manager is injected — CLI
  launch WU still outstanding).
