...
**Design doc:** `docs/history/2026-04-16-design-protocol-client-073-074.md`
**Reviewed against:**
- `docs/features/0009-terminal-harness.md` (FEAT-0009)
- `docs/features/0008-bff-server.md` (FEAT-0008)
- `internal/protocol/protocol.go` and `internal/protocol/messages.go` (WU-039 types)
- `docs/releases/v0.2.0/track-b-terminal-harness.md` (Track B WU descriptions)
- `docs/history/2026-04-16-design-bff-foundation-046-047-048-049.md` (server-side design)
...
- **Spec reference:**
  - `docs/features/0008-bff-server.md:211` -- "heartbeat is harness-initiated"
  - `docs/features/0008-bff-server.md:416-417` -- "Harness sends `connection.ping` every 15 seconds. Server replies with `connection.pong` within 5 seconds."
...
- **Spec reference:**
  - `docs/features/0008-bff-server.md:418` -- "After 3 consecutive missed pongs, harness transitions to `degraded`."
  - `docs/features/0008-bff-server.md:419` -- "After 5 consecutive missed pongs, harness transitions to `reconnecting`."
  - `docs/features/0008-bff-server.md:1224` -- "3 missed pongs at 15s interval = 45s"
