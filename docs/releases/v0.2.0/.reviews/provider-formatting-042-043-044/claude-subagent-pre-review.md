...
**Date:** 2026-04-16
**Subject:** `docs/history/2026-04-16-design-provider-formatting-042-043-044.md`
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:64-69` — `provider.Attachment` fields enumerated: `ContentType`, `Content`, `Raw []byte`, `Transform`. No `Path` field. Comment on `Raw`: "NOT base64 — Go []byte; JSON-encodes as base64 automatically."
  ...
  - `docs/features/0008-bff-server.md:228-236` — `turn.submit` payload schema lists `path` first in the attachment object; it is not optional.
  - `docs/features/0008-bff-server.md:1306-1312` — example `protocol.Attachment` struct in FEAT-0008 §"Interface Definition" uses `Raw []byte`, not `Raw string`. This is a pre-existing FEAT-0008 ↔ `internal/protocol/messages.go` drift that WU-039 already resolved in favor of `string`, and the design here re-introduces the inconsistency with a THIRD shape.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:128` — `ErrNotImplemented = errors.New("provider: not implemented")` — new sentinel in `internal/provider/provider.go`.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:233` — `var ErrNotImplemented = errors.New("provider: method not implemented")`.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:134-139` — D4 truncation algorithm.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:269` — `TestTruncate_PairAtomicity` covers "dropping a tool message also drops its paired tool-call assistant" — single-pair only.
  - `docs/features/0008-bff-server.md:60` — "Multiple `tool.call` events may be emitted in sequence within a single turn, each requiring a `tool.result` before the stream continues." — Multi-call-per-turn is explicitly in-scope.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:89-104` — interface methods and opts struct.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:164-175` — Anthropic "Full wire body" JSON shows `"tools": [...]` embedded inline.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:191-200` — OpenAI wire body same.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:219-220` — front-matter design.
  ...
  - `docs/history/2026-04-16-design-protocol-types-040-041-093.md` (protocol bundle design, reviewed separately) did not take a stance on amendment format.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:95-104` — opts struct.
  - `docs/features/0008-bff-server.md:660` — plan-mode read-only tool expectation.
  - `docs/features/0008-bff-server.md:100` — vision-capability gating.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:140-148` — D4 token estimation section; chars/4 formula; no per-message breakdown.
  - `docs/features/0008-bff-server.md:976` — "the server maintains a running token count for the full conversation (system prompt + history + knowledge injections + current turn)" — mentions aggregate, not per-field decomposition.
  - `docs/features/0008-bff-server.md:329-330` — `session.context.list` response has `system_prompt_tokens: 4200, knowledge_injection_tokens: 1800` — the product exposes per-category breakdowns to the user, so the server must track them somewhere.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:84-87` — return type `[]byte`, comment "complete HTTP request body."
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:272-273` — test plan "Table-driven against golden-JSON fixtures (inline in test, not separate files)" — no normalization mentioned.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:306-310` — Deviations list.
  - `docs/releases/v0.2.0/track-0-shared.md:60-66` — WU-042 spec.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:58-62`
  - `internal/protocol/messages.go:77-84`
  - `docs/features/0008-bff-server.md:113-141` — success/rejected/error examples.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:138-139` — step 5 error mention.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:232-236` — D8 sentinel list.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:14` — WU-042/043/044 scope.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:17-24` — Out of scope: "Conversation state construction (WU-051)".
  - `docs/features/0008-bff-server.md:469` — `token_replay_available` flag.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:191-200` — wire body.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:205-211` — D6 code snippet with ignored error.
...
- **Evidence:**
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:266` — test listed without opts detail.
  - `docs/history/2026-04-16-design-provider-formatting-042-043-044.md:121-126` — both methods are stubbed; test covers FormatMessages only.
