...
**Date:** 2026-04-16
**Design doc:** `docs/history/2026-04-16-design-bubbletea-scaffold-068-069-070-071-072.md`
**Checked against:**
- `docs/features/0009-terminal-harness.md` (FEAT-0009 spec)
- `internal/protocol/messages.go` and `internal/protocol/protocol.go` (protocol types)
- `docs/releases/v0.2.0/track-b-terminal-harness.md` (WU descriptions)
