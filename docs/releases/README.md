...
| [v0.3.0](v0.3.0/) | phase 2 review processed; phase 3 blocked | Run runtime foundation (FEAT-0016, FEAT-0017 slice) |
...
| FEAT-0015 (Professional Harness Runtime) | v0.3.0–v0.3.4 | Umbrella series, v0.3.0 Phase 2 review processed |
| FEAT-0016 (Managed Codegen Run Pipeline) | v0.3.0 | Phase 2 review processed |
| FEAT-0017 (Durable Runs and Background Agents) | v0.3.0 | Foundation slice, Phase 2 review processed |
