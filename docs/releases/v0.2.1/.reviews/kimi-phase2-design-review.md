...
- **Severity:** blocking
- **Location:** `docs/releases/v0.2.1/plan.md` table row WU-100, "Parallelizes With" column
...
- **What's wrong:** `WU-101` says docs should become "a developer-facing markdown doc under repo docs" but does not name a file path. Given project conventions (`docs/features/`, `docs/patches/`, `docs/releases/`), the final doc location should be explicit.
