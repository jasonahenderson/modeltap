...
- `docs/releases/v0.2.1/plan.md` — work-unit table
- `docs/releases/v0.2.1/track-a-harness-shell-componentization.md` — WU-100 / WU-102 dependency summary
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-host-adapter-integration-099.md` — Minimal Host Interface
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-shell-component-api-098.md` — Host Event Contract
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-host-adapter-integration-099.md` — Context
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-extraction-implementation-100.md` — Extraction Sequence / Step 2
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-parity-regression-102.md` — Required Parity Coverage Areas / Transcript and composer surface
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-parity-regression-102.md` — Required Parity Coverage Areas / Queue behavior
...
- `docs/releases/v0.2.1/designs/2026-04-25-design-shell-component-api-098.md` — Action Contract / `RunCommandAction`
- `docs/releases/v0.2.1/designs/2026-04-25-design-host-adapter-integration-099.md` — Command Routing Split
