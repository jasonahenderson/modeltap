...
- Added `docs/explorations/README.md` to define the exploration artifact, lifecycle, statuses, front matter, and promotion rules.
...
- Updated `docs/features/README.md`, `docs/patches/README.md`, and `docs/adr/README.md` so each references explorations as the upstream artifact.
...
- `docs/adr/README.md`
- `docs/history/2026-04-10-admin-explorations-and-agent-instructions.md`
