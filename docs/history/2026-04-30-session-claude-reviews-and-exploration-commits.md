...
2. Review FEAT-0015 through FEAT-0022 for completeness, consistency, and logic,
   and save findings under `docs/features/.reviews/` using the `claude`
...
`docs/features/.reviews/` using the `{stem}-claude-findings.{md,json}`
...
- `docs/features/.reviews/00{15..22}-*-claude-findings.md` (8 files)
- `docs/features/.reviews/00{15..22}-*-claude-findings.json` (8 files)
