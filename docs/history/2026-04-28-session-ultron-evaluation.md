...
- `docs/explorations/0013-ultron-evaluation.md` — EXP-0013 exploration
  (status: `watching`).
- `docs/history/2026-04-28-session-ultron-evaluation.md` — this log.

## Files Modified

- `docs/explorations/README.md` — added EXP-0013 to the index; added
