...
### Docs Updates
- `docs/patches/0011-harness-ux-polish.md` — status flipped to `done`
- `docs/patches/README.md` — PATCH-0011 marked `done`
- `docs/releases/v0.2.0/changelog.md` — Added theme system and keybindings to headline additions
