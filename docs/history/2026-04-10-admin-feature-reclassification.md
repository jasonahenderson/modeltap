...
Reclassified the unimplemented, upstream, and implementation-scoped documents so `docs/features/` now contains only concrete feature contracts that correspond to implemented product work.
...
- Moved docs from `docs/features/` into `docs/explorations/` and `docs/patches/`
- Updated indexes in `docs/features/README.md`, `docs/explorations/README.md`, and `docs/patches/README.md`
