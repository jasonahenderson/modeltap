...
date: "2026-05-11"
related:
  - ".sdlc/releases/v0.3.0/retrospective.md (Finding F14)"
...
`.sdlc/releases/v0.3.0/retrospective.md`. Local-provider streaming
...
- [ ] `.sdlc/releases/v0.3.0/retrospective.md` F14 entry references
  this patch as fix
