...
related:
  ...
  - ".sdlc/releases/v0.3.0/retrospective.md (Finding F11)"
...
Recorded as Finding F11 in `.sdlc/releases/v0.3.0/retrospective.md`.
...
- [ ] `.sdlc/releases/v0.3.0/retrospective.md` Finding F11 status
