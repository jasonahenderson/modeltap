...
3. Add the README to `.sdlc/releases/v0.2.0/changelog.md` under a docs entry (if the release is still open; otherwise note in status.md).
...
- A "Features" matrix / roadmap table. That belongs in `.sdlc/releases/` and `.sdlc/features/`; duplicating it in the README guarantees drift.
