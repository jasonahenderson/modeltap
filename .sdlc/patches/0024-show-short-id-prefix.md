...
related:
  ...
  - ".sdlc/releases/v0.3.0/retrospective.md (Finding F6)"
...
Recorded as Finding F6 in `.sdlc/releases/v0.3.0/retrospective.md`.
...
- [ ] `.sdlc/releases/v0.3.0/retrospective.md` Finding F6 status
