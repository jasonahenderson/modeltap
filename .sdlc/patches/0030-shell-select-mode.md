...
related:
  ...
  - ".sdlc/releases/v0.3.0/retrospective.md (Finding F12)"
...
Recorded as Finding F12 in `.sdlc/releases/v0.3.0/retrospective.md`.
...
- [x] `.sdlc/releases/v0.3.0/retrospective.md` Finding F12 status
