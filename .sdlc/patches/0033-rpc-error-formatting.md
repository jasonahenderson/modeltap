...
date: "2026-05-11"
related:
  - ".sdlc/releases/v0.3.0/retrospective.md (Finding F15)"
...
spec (`.sdlc/releases/v0.3.0/smoke-test.md:84`) accepts the rejection,
but the user has no hint that they can still inspect the completed
run with `/run <run-id>`.

Recorded as Finding F15 in `.sdlc/releases/v0.3.0/retrospective.md`.
...
- [ ] `.sdlc/releases/v0.3.0/retrospective.md` F15 entry references
  this patch as fix
