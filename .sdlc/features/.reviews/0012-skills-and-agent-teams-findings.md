...
- Feature: `.sdlc/features/0012-skills-and-agent-teams.md`
...
**Detail:** FEAT-0012 says skills are harness-side and require no new server capabilities, while agent teams require BFF-coordinated multi-agent orchestration, shared context, concurrency, cost controls, and policy enforcement (`.sdlc/features/0012-skills-and-agent-teams.md:29-35`, `:38-86`, `:88-186`, `:423-445`). Those are not one unit of behavior or risk. As written, a lightweight skill implementation and a safe agent-team implementation either block each other or get accepted together without equivalent maturity.
