# Python: Model-Family Prompt Variants

This file combines model-family guidance with Python modules, services, libraries, and repositories review and repair use cases.
...
### Large review
Review Python modules, services, libraries, and repositories with a principal-engineer lens. Prioritize correctness, production risk, maintainability, and explicit evidence.

### Small review
Review Python modules, services, libraries, and repositories concisely. Focus on major issues only. No cosmetic commentary.

### Large repair
Repair Python modules, services, libraries, and repositories with the smallest auditable change set. Preserve interfaces unless a bug fix requires change.
...
### Large review
Assess the quality of the engineering decisions in Python modules, services, libraries, and repositories. Explain where the design choices are weak or fragile.
...
### Large review
Review Python modules, services, libraries, and repositories as production code. Highlight missing safeguards, hidden assumptions, and maintenance traps.

### Small review
Prioritize the top production risks in Python modules, services, libraries, and repositories.
...
### Large review
Review Python modules, services, libraries, and repositories with sharp prioritization. Focus on risk, fragility, and unnecessary complexity.
...
### Large review
Assess Python modules, services, libraries, and repositories by identifying concrete design choices and their downstream consequences.
...
### Large review
Assess whether Python modules, services, libraries, and repositories reflects strong engineering judgment, especially around boundaries, lifecycle, and future change.
...
### Large review
Review Python modules, services, libraries, and repositories for correctness, reliability, maintainability, and operational risk.
