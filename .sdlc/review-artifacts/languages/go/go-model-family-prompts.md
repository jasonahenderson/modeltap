# Go: Model-Family Prompt Variants

This file combines model-family guidance with Go packages, services, and repositories review and repair use cases.
...
### Large review
Review Go packages, services, and repositories with a principal-engineer lens. Prioritize correctness, production risk, maintainability, and explicit evidence.

### Small review
Review Go packages, services, and repositories concisely. Focus on major issues only. No cosmetic commentary.

### Large repair
Repair Go packages, services, and repositories with the smallest auditable change set. Preserve interfaces unless a bug fix requires change.
...
### Large review
Assess the quality of the engineering decisions in Go packages, services, and repositories. Explain where the design choices are weak or fragile.
...
### Large review
Review Go packages, services, and repositories as production code. Highlight missing safeguards, hidden assumptions, and maintenance traps.

### Small review
Prioritize the top production risks in Go packages, services, and repositories.
...
### Large review
Review Go packages, services, and repositories with sharp prioritization. Focus on risk, fragility, and unnecessary complexity.
...
### Large review
Assess Go packages, services, and repositories by identifying concrete design choices and their downstream consequences.
...
### Large review
Assess whether Go packages, services, and repositories reflects strong engineering judgment, especially around boundaries, lifecycle, and future change.
...
### Large review
Review Go packages, services, and repositories for correctness, reliability, maintainability, and operational risk.
