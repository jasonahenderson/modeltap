...
- `.sdlc/features/0008-bff-server.md:1225-1227`: "`session.sync` returns branch states"
...
- `.sdlc/features/0008-bff-server.md:503`: Only 12 codes defined
...
**Design Document Reference:**
- `.sdlc/features/0009-terminal-harness.md`: "MCP tool discovery (required)"
