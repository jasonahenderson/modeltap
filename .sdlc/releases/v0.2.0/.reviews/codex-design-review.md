...
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-protocol-types-040-041-093.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-provider-formatting-042-043-044.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-storage-045-091-096.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-bff-foundation-046-047-048-049.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-sessions-conversation-050-051-052.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-streaming-prompts-cost-053-054-055-056.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-model-config-routing-057-058-059-060.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-context-diagnostics-recovery-061-062-063-064.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-cli-ollama-history-065-066-091.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-bubbletea-scaffold-068-069-070-071-072.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-protocol-client-073-074.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-tool-framework-075-076-077-078-079.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-harness-features-080-086-092.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-track-integration-tests-067-087.md`
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-integration-track-088-090-094-095.md`
...
The protocol-types and BFF-foundation bundles agree that `capabilities.register` returns `protocol.CapabilitiesRegisterResponse` with `registered`, `server_capabilities`, and optional `rejected` fields (`.sdlc/releases/v0.2.0/designs/2026-04-16-design-protocol-types-040-041-093.md:283`, `.sdlc/releases/v0.2.0/designs/2026-04-16-design-bff-foundation-046-047-048-049.md:516`). But the harness protocol-client bundle defines a different `RegisterResponse` with top-level `negotiated_version`, `server_version`, `max_frame_size`, and `max_attachment_size` (`.sdlc/releases/v0.2.0/designs/2026-04-16-design-protocol-client-073-074.md:185`).
...
The BFF foundation design says oversize attachments are rejected with diagnostic `MT-CONN-013` (`.sdlc/releases/v0.2.0/designs/2026-04-16-design-bff-foundation-046-047-048-049.md:589`). The protocol-types bundle and the diagnostics bundle both define the taxonomy as exactly 12 codes, `MT-CONN-001` through `MT-CONN-012` (`.sdlc/releases/v0.2.0/designs/2026-04-16-design-protocol-types-040-041-093.md:328`, `.sdlc/releases/v0.2.0/designs/2026-04-16-design-context-diagnostics-recovery-061-062-063-064.md:212`). FEAT-0008 also enumerates only those 12 (`.sdlc/features/0008-bff-server.md:503`).
...
The provider-formatting bundle is the shared contract bundle for the `Provider` interface and its ADR-0006 amendment. Its interface design includes `FormatMessages` and `FormatToolDefinitions`, but not stream-event parsing (`.sdlc/releases/v0.2.0/designs/2026-04-16-design-provider-formatting-042-043-044.md:84`). Bundle 10 later adds a new `ParseStreamEvent` interface method and says it “will be added as an amendment” (`.sdlc/releases/v0.2.0/designs/2026-04-16-design-streaming-prompts-cost-053-054-055-056.md:128`, `:509`).
