...
- `.sdlc/history/<date>-security-feat-0008-0009.md` — formal review document
- `.sdlc/patches/` entries for findings requiring follow-up
...
- `.sdlc/releases/v0.2.0/perf-budgets.md` — canonical budget table with reference machine spec
...
| NEW | `.sdlc/releases/v0.2.0/changelog.md` | 090 |
...
| NEW | `.sdlc/releases/v0.2.0/perf-budgets.md` | 095 |
