...
Subagent pre-review lint ran against the initial draft. Review artifact: `.sdlc/releases/v0.2.0/.reviews/provider-formatting-042-043-044/claude-subagent-pre-review.md`. Findings and dispositions:
