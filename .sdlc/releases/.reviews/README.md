...
- `.sdlc/releases/v0.2.0/.reviews/codex-plan-review.md`
- `.sdlc/releases/v0.2.0/.reviews/codex-readiness-review.md`
- `.sdlc/releases/v0.2.0/.reviews/codex-post-ship-review.md`
...
Do not use `.sdlc/history/` as the canonical home for these reviews. `.sdlc/history/` is the session/work log and should only note that the review happened and link to the release-local artifact.
