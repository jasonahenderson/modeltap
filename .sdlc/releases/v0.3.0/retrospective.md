...
`.sdlc/history/2026-05-07-session-v0.3.0-smoke-test.md`.
...
- **Handoff doc.** `.sdlc/history/2026-05-07-session-v0.3.0-smoke-test.md`
...
- `.sdlc/history/2026-05-07-session-v0.3.0-smoke-test.md` — already-pending handoff log from the prior session
- `.sdlc/releases/v0.3.0/retrospective.md` — this file
