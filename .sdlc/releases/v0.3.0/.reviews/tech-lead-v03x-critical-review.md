...
- `.sdlc/features/0015-professional-harness-runtime.md`: `status: draft`
- `.sdlc/features/0016-managed-codegen-run-pipeline.md`: `status: draft`
- `.sdlc/releases/v0.3.0/plan.md`: Phase 1 opens by `ADMIN:` commit only
...
- `.sdlc/releases/README.md`: v0.2.0/v0.2.1/v0.2.2 statuses
- `.sdlc/releases/v0.3.0/plan.md`: v0.2.x prerequisites
- `.sdlc/releases/v0.3.0/status.md`: prerequisite confirmation is only an open
  item before Phase 3
...
- `.sdlc/features/0015-professional-harness-runtime.md`: workspace policy
  success criterion
- `.sdlc/releases/v0.3.3/plan.md`: `worktree`/`temp_copy` default deferral
- `.sdlc/releases/v0.3.3/plan.md`: WU-144 background blocked-operation behavior
...
- `.sdlc/features/0015-professional-harness-runtime.md`: supporting patch is not
  in the behavior-contract map until drafted
- `.sdlc/releases/v0.3.2/plan.md`: WU-136 depends on `PATCH-NNNN`
- `.sdlc/releases/v0.3.2/plan.md`: DoD requires the patch to exist and run
...
- `.sdlc/features/0015-professional-harness-runtime.md`: Future ADR list
- `.sdlc/releases/v0.3.0/plan.md`: WU-109/WU-113 schema and stage ownership
- `.sdlc/releases/v0.3.1/plan.md`: prompt/context metadata activation
- `.sdlc/releases/v0.3.2/plan.md`: artifact and approval metadata activation
- `.sdlc/releases/v0.3.3/plan.md`: policy/workspace metadata activation
...
- `.sdlc/releases/v0.3.4/plan.md`: split/defer condition
- `.sdlc/releases/v0.3.4/plan.md`: WU-154 depends on WU-153
- `.sdlc/releases/v0.3.4/plan.md`: DoD includes workflow-extension alignment
