...
| [v0.3.1](v0.3.1/) | planning draft | Context planner and project rules (FEAT-0018, PATCH-0017 prerequisite) |
...
- `.sdlc/releases/vX.Y.Z/.reviews/codex-plan-review.md`
...
`.sdlc/history/` remains the work-log location, but it should point to the canonical review artifact rather than serving as the review artifact itself.
...
Log tag moves in `.sdlc/history/` with the old SHA, new SHA, and reason. Once a
...
| FEAT-0018 (Context Planner and Project Rules) | v0.3.1 | Planning draft; includes PATCH-0017 session-scoped project context prerequisite |
