...
- `.sdlc/history/2026-04-16-admin-process-structure-alignment.md`
...
- `.sdlc/history/2026-04-16-admin-cross-repo-process-consolidation-checklist.md`
...
- `.sdlc/history/20260416-1730-admin-semver-release-design-review.md`
- `.sdlc/history/20260416-1815-admin-process-core-migration-plan.md`
...
3. The duplicated patch hook utility in both `keyproxy/alpha` and
   ...
   while those repos use `.sdlc/patches`.
...
> Read `.sdlc/history/2026-04-17-session-process-core-handoff.md` in `modeltap`
