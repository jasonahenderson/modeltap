...
- Decided the review is a cross-feature synthesis (not a per-feature canonical review) and should live under `.sdlc/features/.reviews/syntheses/`.
...
- **Created:** `.sdlc/features/.reviews/syntheses/kimi-feat-0015-0022-review.md`
- **Created (temporary, removed):** `.reviews/kimi-feat-0015-0022-review.md` (moved then directory removed)
- **Created:** `.sdlc/features/.reviews/syntheses/` directory
