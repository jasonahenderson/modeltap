...
- Handoff document lives in `.sdlc/history/` with a `handoff-` filename prefix, rather than inventing a new `docs/handoffs/` directory. Single file for now; convention can firm up if more accumulate.
...
- Wrote `.sdlc/history/2026-04-21-handoff-harness-debug.md` — forward-looking handoff covering: branch + build state, launch commands, code-layout table (harness / BFF / protocol / tools), accepted / proposed docs to consult, known open issues, first-move suggestions, today's just-landed commits.
...
- `.sdlc/history/2026-04-21-handoff-harness-debug.md` (new)
- `.sdlc/history/2026-04-21-session-harness-handoff.md` (this file, new)
