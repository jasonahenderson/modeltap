...
- Drafted `.sdlc/patches/0010-makefile-hygiene.md` (status: done, same-session approval).
- Registered PATCH-0010 in `.sdlc/patches/README.md` and `.sdlc/releases/v0.2.0/changelog.md`.
...
- `.sdlc/patches/0010-makefile-hygiene.md`
- `.sdlc/history/2026-04-21-session-makefile-hygiene.md`

## Files modified

- `Makefile` — `GO ?= go`, split `fmt` / `fmt-check`, rewired `all:`
- `.sdlc/patches/README.md` — PATCH-0010 registered
- `.sdlc/releases/v0.2.0/changelog.md` — PATCH-0010 row added to Patches table
