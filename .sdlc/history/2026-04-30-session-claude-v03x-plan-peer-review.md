...
- `.sdlc/releases/v0.3.0/.reviews/claude-plan-review.md`
- `.sdlc/releases/v0.3.1/.reviews/claude-plan-review.md`
- `.sdlc/releases/v0.3.2/.reviews/claude-plan-review.md`
- `.sdlc/releases/v0.3.3/.reviews/claude-plan-review.md`
- `.sdlc/releases/v0.3.4/.reviews/claude-plan-review.md`
- `.sdlc/features/.reviews/syntheses/0015-0022-id-hygiene-claude.md`
- `.sdlc/features/.reviews/syntheses/0015-0022-id-hygiene-claude.json`
...
`.sdlc/features/.reviews/syntheses/` per the README's cross-feature
...
outputs. Saved to `.sdlc/features/.reviews/syntheses/`.

Files added:

- `.sdlc/features/.reviews/syntheses/0015-0022-ownership-claude.md`
...
JSON findings format described in `.sdlc/features/.reviews/README.md`.
