...
- Added `.sdlc/releases/v0.2.1/plan.md`
- Added `.sdlc/releases/v0.2.1/track-a-harness-shell-componentization.md`
- Updated release indexing in `.sdlc/releases/README.md`
