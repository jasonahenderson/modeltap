...
### Design docs
- `.sdlc/history/2026-04-16-design-wu-039-protocol-core.md` (WU-039 — retroactive)
- `.sdlc/history/2026-04-16-design-protocol-types-040-041-093.md` (Track 0 Bundle 1)
- `.sdlc/history/2026-04-16-design-provider-formatting-042-043-044.md` (Track 0 Bundle 2)
- `.sdlc/history/2026-04-16-design-storage-045-091-096.md` (Track 0 Bundle 3)

### Pre-review lint artifacts
- `.sdlc/releases/v0.2.0/.reviews/wu-039/claude-subagent-pre-review.md`
- `.sdlc/releases/v0.2.0/.reviews/wu-039/codex-design-and-code-review.md` (peer review)
- `.sdlc/releases/v0.2.0/.reviews/protocol-types-040-041-093/claude-subagent-pre-review.md`
- `.sdlc/releases/v0.2.0/.reviews/provider-formatting-042-043-044/claude-subagent-pre-review.md`
- `.sdlc/releases/v0.2.0/.reviews/storage-045-091-096/claude-subagent-pre-review.md`

### Security reviews
- `.sdlc/history/2026-04-16-security-wu-039-protocol-core.md`

### Session logs
- `.sdlc/history/2026-04-16-session-v0.2.0-kickoff-and-wu-039.md`
- `.sdlc/history/2026-04-16-release-v0.2.0-test-coverage-gap-review.md`
- `.sdlc/history/2026-04-16-design-review-workflow.md`
- `.sdlc/history/2026-04-16-wu-039-peer-review-codex.md` (user-authored)
- `.sdlc/history/2026-04-16-session-phase1-track0-and-workflow.md` (this file)
...
- `.sdlc/releases/v0.2.0/plan.md` (phased execution, test tiers, review tiers)
- `.sdlc/releases/v0.2.0/status.md` (phase tracking)
- `.sdlc/releases/v0.2.0/track-0-shared.md` (tier tags, WU-040 envelope decision, WU-093/096 specs)
- `.sdlc/releases/v0.2.0/track-a-bff-server.md` (tier tags, WU-046 inherited criteria)
- `.sdlc/releases/v0.2.0/track-b-terminal-harness.md` (tier tags)
- `.sdlc/releases/v0.2.0/track-integration.md` (tier tags, WU-094/095 specs)
...
**Resumption protocol:**
1. Read `.sdlc/releases/v0.2.0/status.md` — confirms Phase 1, Track 0 done.
2. Read `docs/agents.md` §"Prime directives" — confirms Phase 1 = design only, no code.
3. Read `.sdlc/releases/v0.2.0/plan.md` §"Design Review Tiers" and the Track A bundle list there — identifies the next bundles.
