...
- README belongs in `.sdlc/patches/` as PATCH-0009, not `.sdlc/features/`. Patches are implementation-scoped; a docs addition with a clear checklist fits that shape.
...
- Drafted `.sdlc/patches/0009-root-readme.md` (status: proposed → approved → done in one session).
- Registered PATCH-0009 in `.sdlc/patches/README.md` index.
- Wrote `README.md` at the repo root.
- Added a pointer at the top of `docs/usage-guide.md` back to the README.
- Updated `.sdlc/releases/v0.2.0/changelog.md` Patches table with PATCH-0009 (and backfilled PATCH-0006 and PATCH-0007 rows, which were missing).
...
- `README.md`
- `.sdlc/patches/0009-root-readme.md`
- `.sdlc/history/2026-04-21-session-root-readme.md`

## Files modified

- `.sdlc/patches/README.md` — PATCH-0009 registered, status set to done
- `docs/usage-guide.md` — README pointer at top
- `.sdlc/releases/v0.2.0/changelog.md` — Patches table updated with PATCH-0006, PATCH-0007, PATCH-0009
