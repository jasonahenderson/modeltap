...
- `.sdlc/releases/v0.2.0/track-0-shared.md` — tier on all 9 WUs
- `.sdlc/releases/v0.2.0/track-a-bff-server.md` — tier on all 23 WUs
- `.sdlc/releases/v0.2.0/track-b-terminal-harness.md` — tier on all 21 WUs
- `.sdlc/releases/v0.2.0/track-integration.md` — tier on all 5 WUs

## Retroactive WU-039 Review

WU-039 shipped without review (design-review workflow didn't exist yet). Running a retroactive Tier-C review via Claude subagent as the first trial of the new process. Artifact will land at `.sdlc/releases/v0.2.0/.reviews/wu-039/claude-subagent-design-review.md`. Any blocking findings will be fixed before WU-040 begins.
