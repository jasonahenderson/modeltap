...
- Drafted `.sdlc/patches/0014-bff-shutdown-waitgroup-race.md` with full problem/scope/fix detail.
- Added PATCH-0014 to `.sdlc/patches/README.md` index (status: approved).
- Added PATCH-0014 entry to `.sdlc/releases/v0.2.0/changelog.md` Patches table.
...
- `.sdlc/patches/README.md` — added PATCH-0014 row.
- `.sdlc/releases/v0.2.0/changelog.md` — added PATCH-0014 row with "Shipped" framing.

Created:
- `.sdlc/patches/0014-bff-shutdown-waitgroup-race.md` — patch doc.
- `.sdlc/history/2026-04-22-session-patch-0014-bff-waitgroup-race.md` — this log.
