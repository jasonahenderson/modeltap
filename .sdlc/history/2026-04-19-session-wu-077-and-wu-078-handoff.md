...
**Release:** v0.2.0 (`.sdlc/releases/v0.2.0/`)
...
Session log: `.sdlc/history/2026-04-19-session-wu-077-and-wu-078.md`.
Catch-up log (Bundle 6 + WU-075): `.sdlc/history/2026-04-19-session-bundle-6-and-wu-075.md`.
...
> Read `.sdlc/history/2026-04-19-session-wu-077-and-wu-078-handoff.md`
...
- `.sdlc/releases/v0.2.0/status.md` — authoritative progress
- `internal/harness/tools/` — existing tools + framework
- `.sdlc/releases/v0.2.0/designs/2026-04-16-design-tool-framework-075-076-077-078-079.md` — Bundle 7 design (WU-079 spec is D11–D14; test list lines 738+)
