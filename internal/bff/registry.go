		...
		ProviderTypeAnthropic: {
			{
				...
				Description:     "Anthropic flagship — best for complex reasoning and agentic coding",
			},
			{
				...
				Capabilities:    []string{"tool_use", "vision"},
				Description:     "Prior-generation flagship with extended thinking support",
			},
			{
				...
				Capabilities:    []string{"tool_use", "vision"},
				Description:     "Best speed-to-intelligence balance for daily work",
			},
			{
		...
		ProviderTypeOpenAI: {
			{
				...
				CostPer1kOutput: 0.015,
				Capabilities:    []string{"tool_use", "vision"},
				Description:     "OpenAI frontier flagship for agentic and coding workflows",
			},
			{
				Name:            "gpt-5",
				Provider:        ProviderTypeOpenAI,
			...
			},
			{
				...
				Capabilities:    []string{"tool_use"},
				Description:     "Reasoning-optimized model for STEM and logic tasks",
			},
			{
				Name:            "o4-mini",
				Provider:        ProviderTypeOpenAI,
				...
				Capabilities:    []string{"tool_use"},
				Description:     "Fast reasoning model for lightweight STEM work",
			},
		},
		ProviderTypeOllama: {
			{
				...
				CostPer1kOutput: 0,
				Capabilities:    []string{"tool_use"},
				Description:     "Best all-rounder for consumer GPUs (~10 GB VRAM)",
			},
			{
				...
				CostPer1kOutput: 0,
				Capabilities:    []string{},
				Description:     "Strong reasoning and math on modest hardware",
			},
			{
				Name:            "gemma3:27b",
				Provider:        ProviderTypeOllama,
				...
				Description:     "Quality writing and long-document handling",
			},
			{
				Name:            "llama3.2:8b",
				Provider:        ProviderTypeOllama,
				...
				CostPer1kOutput: 0,
				Capabilities:    []string{},
				Description:     "Lightweight multilingual chat model",
			},
		},
	}
}
