...
// Runtime OOMs. WU-094 H-4. 1 MiB is generous for real provider payloads
...
// sseMaxLineBytes so an adversarial upstream can't OOM the Runtime.
...
// silently skipped — the Runtime only needs the data payload because both
...
// WithRun binds the relay to the durable Runtime run that owns this turn.
